        ...
        <div className="logo-div h-48 w-48">
          ...
          <svg id="Layer_1" className="logo logo-spin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.59 110.71">
            <defs>
              ...
              {/* <clipPath clipPathUnits="objectBoundingBox" id="circle-mask">
            <circle cx="1" cy="1" r="1" strokeWidth="0"></circle>
        </clipPath> */}
            </defs>
            {/* <mask id="m1"> */}
              {/* <rect width="100vh" height="100vw" fill="black" /> */}
            ...
            {/* </mask> */}
            {/* <mask id="m2" maskContentUnits="userSpaceOnUse">
              <rect width="100vh" height="100vw" fill="white" />
            </mask> */}
          </svg>
        </div>
